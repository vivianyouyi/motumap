...
@interface RoutePlanVC ()<MAMapViewDelegate, AMapSearchDelegate,AMapLocationManagerDelegate>
/* 路径规划类型 */
...
- (void)viewDidLoad
{
    ...
    NSLog(@"latitude:{%f};", self.destination.latitude);
    NSLog(@"longitude:{%f};", self.destination.longitude);
    [self initlocation];
...
- (void)initlocation{
    ...
    [self.locationManager requestLocationWithReGeocode:YES completionBlock:^(CLLocation *location, AMapLocationReGeocode *regeocode, NSError *error) {
        ...
        self.destinationCoordinate  = CLLocationCoordinate2DMake(self.destination.latitude, self.destination.longitude);
